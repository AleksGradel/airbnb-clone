...
import { FaSearch, FaRegHeart, FaRegUserCircle, FaAirbnb, FaRegCommentAlt } from 'react-icons/fa'
    ...
    return (
        <div className='absolute'>
            <div className='w-full z-50 fixed bottom-0 h-16 bg-white border-t border-grey-light 
                ...
                { user && <div className='flex flex-col justify-center cursor-pointer'>
                ...
                { user 
                    ...
                    : <Link href='/login'>
                        <div className='flex flex-col justify-center cursor-pointer'>
                            <span className={`${router.pathname === '/login' || router.pathname === '/signin'  ? 'text-pink' : 'text-grey'} text-xl self-center`}>
                                <FaRegUserCircle />
                            </span>
