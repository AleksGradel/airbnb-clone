...
function SearchDefault({ expandSearch }) {
    return (
        ...
        >
            <span className='text-sm pl-4 pr-2 border-r border-grey-light'>
                Anywhere
            </span>
            <span className='text-sm px-2 border-r border-grey-light'>
                Any week
            </span>
            <span className='text-sm px-2'>Add guests</span>
            <button className='flex justify-center items-center bg-pink text-white rounded-full w-10 h-10'>
                <FaSearch />
            </button>
        </div>
    )
