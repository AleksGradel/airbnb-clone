  ...
  return (
    <div className='my-8 flex flex-col'>
      ...
      <div 
        ...
        <span className='font-bold underline underline-offset-4'>Show more</span>
        <FaChevronRight className='ml-2'/>
      </div>
      <Transition appear show={showDescription} as={Fragment}>
        <Dialog as='div' className='relative z-10' onClose={()=>setShowDesription(false)}>
          <Transition.Child
            as={Fragment}
            ...
            <div className='flex min-h-full items-center justify-center p-4 text-center'>
              ...
              >
                <Dialog.Panel
                  ...
                  <div>
                    <button 
                        onClick={()=>setShowDesription(false)} 
