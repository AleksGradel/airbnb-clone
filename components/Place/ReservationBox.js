...
function ReservationBox({ 
    ...
    showCalendar }) {
        ...
        <div className='flex flex-col'>
            ...
            <div 
                className='mb-2 border border-grey rounded-lg cursor-pointer'>
                <div className='flex flex-row text-sm' onClick={showCalendar}>
                    <div className='flex flex-col p-2 w-1/2 border-r border-grey'>
                        <span className=''>Check in</span>
                        <span>{checkinDate}</span>
                    </div>
                    <div className='flex flex-col p-2 w-1/2' onClick={showCalendar}>
                        <span>Checkout</span>
