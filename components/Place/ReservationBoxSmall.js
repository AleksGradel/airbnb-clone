...
const ReservationBoxSmall = ({
    ...
    return (
        <div className='absolute'>
            <div
                className='w-full z-50 fixed bottom-0 h-20 bg-white border-t border-grey-light 
            ...
            >
                ...
                <div className={`${showReservationBox ? 'w-full' : ''}`}>
                    {!showReservationBox ? (
                        <button
                            className='bg-pink rounded-lg py-3 px-6 text-white font-bold text-sm'
                        ...
                        <button
                            className='w-full bg-pink rounded-lg py-3 px-6 text-white font-bold text-sm'
                    ...
                    <Transition appear show={showReservationBox} as={Fragment}>
                        <Dialog
                            ...
                            onClose={() => setShowReservationBox(false)}
                        >
                            <Transition.Child
                                as={Fragment}
                                            ...
                                            <div className='flex flex-col mt-4'>
                                                ...
                                                <div className='mb-2 border border-grey rounded-lg'>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <Menu.Items className='absolute right-0 w-full origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none'>
