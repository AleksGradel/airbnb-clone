...
const SelectorRow = ({ label, description, count, incrementAction, decrementAction, maxCount }) => {
    return (
...
const GuestsSelector = ({maxGuestNumber}) => {
    ...
    const checkGuestLimit = Boolean((adultsCount + childrenCount) === maxGuestNumber)
