...
const Signin = () => {
    ...
    return (
        <div
            className={`${
                isSmallDevice ? '' : 'items-center justify-center'
        ...
        >
            ...
            <div
                className={`${
                    isSmallDevice
                        ? ''
                        : 'bg-white rounded-xl border border-grey w-1/2'
                }`}
            >
                ...
                <div className='px-8 pt-6 pb-8 mb-4'>
                    ...
                    <form onSubmit={handleSignin}>
                        ...
                        <div className='flex items-center justify-between'>
                            <button className='w-full font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline bg-pink text-white'>
                                Sign In
                            </button>
                        </div>
                    </form>
